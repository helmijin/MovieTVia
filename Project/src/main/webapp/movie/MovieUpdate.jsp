...
<body>
	<div id="wrap" align="center">
		<h1>상품 수정 - 관리자 페이지</h1>
		<form action="BoardServlet?command=product_update_post" method="post" enctype="multipart/form-data" name="frm">
			...
			<table>
				<tr>
					<td><c:choose>
							...
							<c:otherwise>
								<img class="imgg" src="upload/${product.pictureurl}">
							</c:otherwise>
						</c:choose></td>
					<td>
						<table>
			...
			<br> <input type="submit" value="수정"
				...
				onclick="location.href='BoardServlet?command=product_list'">
		</form>
	</div>
</body>
</html>